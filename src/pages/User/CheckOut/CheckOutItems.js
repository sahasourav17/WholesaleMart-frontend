...
export const CheckOutItems = ({ item }) => {
  ...
  return (
    <tr className="bg-white border-b  hover:bg-gray-50">
      ...
      <td className="px-6 py-4 text-slate-900">&#2547;{price}</td>
      <td className="px-6 py-4">
        <div className="flex bg-green-700 rounded-md overflow-hidden justify-between w-24">
          <button
            disabled={quantity <= 1}
      ...
      <td className="px-6 py-4 text-slate-950">&#2547;{price * quantity}</td>
