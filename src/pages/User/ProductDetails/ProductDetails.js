...
export const ProductDetails = () => {
  ...
  const { name, picture, price, category, description, brand } = product || {};
        ...
        <div className="col-span-12 md:col-span-6 p-3 lg:col-span-5 space-y-3">
          ...
          <div className="flex justify-between items-center border-b-2 pb-2">
            <div className="space-y-2">
              ...
              {/* <div className="flex items-center text-sm font-thin space-x-2">
                <p className="text-green-800">
                  <span className="text-gray-600">Brand:</span> {brand?.name}
                </p>
              </div>
              <div className="flex items-center text-sm font-thin space-x-2">
                <p className="text-green-800">
